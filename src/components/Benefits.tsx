...
const benefits = [
  {
    icon: Zap,
    title: "Torne-se um Especialista em até",
    highlight: "3 meses",
  },
  {
    icon: Clock,
            ...
            <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
              ...
              <div className="animate-fade-in">
                ...
                <p className="text-sm md:text-lg text-white/80 leading-relaxed">
                  Torne-se um <strong className="text-white">Especialista em até 3 meses</strong>, e receba seu{" "}
                  <strong className="text-white">Certificado em apenas 48 horas</strong> após a conclusão do Curso.
                  Aproveite a praticidade do EAD em um Curso sem a necessidade de TCC!
                </p>
              </div>
