...
const Faculty = () => {
  return (
    <section className="pt-12 md:pt-24 pb-16 md:pb-32 relative overflow-hidden" style={{ background: 'linear-gradient(315deg, hsl(230 75% 10%) 0%, hsl(215 70% 40%) 25%, hsl(230 80% 50%) 70%, hsl(192 79% 16%) 100%)' }}>
